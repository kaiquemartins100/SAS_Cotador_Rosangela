...
public class ASO extends ExecutionWrapper {
	...
	public ASO(String executionName, DataDictionary data) {
	...
	public void script() throws Throwable {
		try {
			...
			if((boolean) GlobalData.getData("vTipoFluxo").equals("Duplicar") ||
					GlobalData.getData("vTipoFluxo").equals("Retomar")){
				cotacao.duplimar();
			}else{
				cotacao.novaCotacao();
			}
